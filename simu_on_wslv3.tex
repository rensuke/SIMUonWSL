				...
				(2)zip系の導入
					...
					1.zlib
						...
						環境変数をクロスコンパイル用に設定してmakeを実行する。
							...
							sudo make -f win32/Makefile.gcc BINARY_PATH=$PREFIXDIR/bin INCLUDE_PATH=$PREFIXDIR/include LIBRARY_PATH=$PREFIXDIR/lib SHARED_MODE=1 PREFIX=x86_64-w64-mingw32- install \par
					2.bzip
